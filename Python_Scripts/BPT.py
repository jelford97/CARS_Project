...
for i in range(len(Galaxy_maps)):
    ...
    plt.plot(np.log10(BPT_x),np.log10(y),'o',label='Global')
    ...
    plt.savefig('/Users/jelford/Documents/PhD_Work/CARS_Project/Plots/'+str(Galaxy_abr[i])+'/'+str(Galaxy_abr[i])+'BPT.png')
    plt.close()
    ...
    plt.plot(np.log10(VO_SIIx),np.log10(y),'o',label='Global')
    ...
    plt.savefig('/Users/jelford/Documents/PhD_Work/CARS_Project/Plots/'+str(Galaxy_abr[i])+'/'+str(Galaxy_abr[i])+'V087-SII.png')
    plt.close()
    ...
    plt.plot(np.log10(VO_OIx),np.log10(y),'o',label='Global')
    ...
    plt.savefig('/Users/jelford/Documents/PhD_Work/CARS_Project/Plots/'+str(Galaxy_abr[i])+'/'+str(Galaxy_abr[i])+'V087-OI.png')
    plt.close()
